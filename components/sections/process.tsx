    ...
    <section id="process" className="relative py-24 sm:py-32">
      <div className="mx-auto max-w-6xl px-6">
        <SectionHeader
          ...
          title={
            <>
              A clear and proven <span className="text-gradient-cyan">process</span>
            </>
          }
          description="A structured development process focused on clear communication, quality execution, and reliable project delivery."
        />
        ...
        <div className="mt-16 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {processSteps.map((step, i) => (
            ...
            >
              ...
              <div className="relative h-auto overflow-hidden rounded-2xl border border-white/10 bg-white/[0.02] p-5 backdrop-blur transition-colors hover:border-white/20 hover:bg-white/5">
